...
-- Exportiere Daten aus Tabelle ckaccounting.ck_invoices: ~5 rows (ungefähr)
INSERT INTO `ck_invoices` (`Invoice_ID`, `Category_ID`, `Name`, `Description`, `Amount`, `Date`, `Timestamp`, `isPaid`, `Company_ID`) VALUES
	(109, 7, 'Invoice #2', 'Content Creation', 1250, '2024-11-07', '2021-03-05 11:00:00', 1, 4),
	(110, 7, 'Invoice #1', 'Email Marketing', 800, '2024-11-08', '2021-04-10 11:00:00', 1, -1),
	(112, 8, 'Expense #1', 'Yessir', 183.2, '2024-11-08', '2024-11-08 08:45:38', 1, -1),
	(113, 8, 'Expense #2', 'Thatsright', 937.2, '2024-11-07', '2024-11-08 08:46:13', 1, 4),
	(114, 7, 'Hello How Are You?', 'Thats right!', 845.3, '2024-11-08', '2024-11-08 09:14:54', 1, 4);
