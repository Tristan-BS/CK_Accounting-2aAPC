...
-- Exportiere Daten aus Tabelle ckaccounting.ck_invoices: ~24 rows (ungefähr)
INSERT INTO `ck_invoices` (`Invoice_ID`, `Category_ID`, `Name`, `Description`, `Amount`, `Date`, `Timestamp`, `isPaid`) VALUES
	(2, 2, 'Thats a good question!', 'Something i guess?', 374.39, '2024-11-04', '2024-11-04 07:23:21', 0),
	(5, 3, 'YesterDayDateTimeSalaryINVOICE', 'Thats from yesterday', 3852.85, '2024-11-03', '2024-11-04 07:43:28', 1),
	(6, 7, 'Income Test Data 0', 'Yees', 7283.29, '2024-10-31', '2024-11-04 16:55:35', 0),
	(7, 7, 'Income Test Data 1', 'Yees', 12852.32, '2024-10-22', '2024-11-04 16:55:43', 0),
	(8, 7, 'Income Testing Data 2', 'Yees', 12852.32, '2024-10-22', '2024-11-04 16:55:56', 1),
	(9, 7, 'Income Testing Data 3', 'Yees', 172.38, '2024-10-19', '2024-11-04 16:56:03', 0),
	(11, 7, 'Income Testing Data 5', 'Yees', 18.28, '2024-10-07', '2024-11-04 16:56:23', 1),
	(12, 7, 'Income Testing Data 6', 'Yees', 928.38, '2024-10-04', '2024-11-04 16:56:29', 0),
	(13, 7, 'Income Testing Data 7', 'Yees', 27.93, '2024-10-28', '2024-11-04 16:56:36', 0),
	(14, 7, 'Income Testing Data 8', 'Yees', 952.27, '2024-10-15', '2024-11-04 16:57:22', 0),
	(15, 7, 'Income Testing Data 9', 'Yees', 2653.82, '2024-10-27', '2024-11-04 16:57:32', 0),
	(16, 7, 'Income Testing Data 10', 'Yees', 7271.23, '2024-10-01', '2024-11-04 16:57:41', 1),
	(18, 8, 'Expense Testing Data 1', 'Nooo', 172.48, '2024-10-02', '2024-11-04 16:58:12', 1),
	(19, 8, 'Expense Testing Data 2', 'Nooo', 8422.38, '2024-10-04', '2024-11-04 16:58:24', 1),
	(20, 8, 'Expense Testing Data 3', 'Nooo', 98.29, '2024-10-08', '2024-11-04 16:58:33', 1),
	(22, 8, 'Expense Testing Data 6', 'Nooo', 12.38, '2024-10-24', '2024-11-04 16:59:04', 1),
	(23, 8, 'Expense Testing Data 7', 'Nooo', 92, '2024-10-26', '2024-11-04 16:59:16', 0),
	(24, 8, 'Expense Testing Data 8', 'Nooo', 192.23, '2024-10-29', '2024-11-04 16:59:28', 1),
	(25, 8, 'Expense Testing Data 9', 'Nooo', 9.2, '2024-10-31', '2024-11-04 16:59:36', 1),
	(27, 8, 'Yuppy', '', 2747.28, '2024-11-04', '2024-11-04 18:34:19', 0),
	(28, 8, 'Thats right, im lost', 'wef4fssfsfe', 19849.28, '2024-10-02', '2024-11-05 10:05:50', 1),
	(29, 2, 'Hello My Name is ALEXANDER', 'Yessir mom', 283.28, '2024-11-20', '2024-11-05 10:39:17', 1),
	(30, 8, 'This is a anjidsa  asdas ', 'Nosir', 192.38, '2024-11-25', '2024-11-05 10:39:48', 0),
	(31, 7, 'Not payed yet INCOME', 'Nosir', 1293.29, '2024-11-10', '2024-11-05 10:40:06', 0);

-- Exportiere Struktur von View ckaccounting.ck_invoices_with_category
-- Erstelle temporäre Tabelle, um View-Abhängigkeiten zuvorzukommen
CREATE TABLE `ck_invoices_with_category` (
	`InvoiceName` VARCHAR(50) NULL COLLATE 'utf8mb4_general_ci',
	`Amount` DOUBLE NULL,
	`Date` DATE NULL,
